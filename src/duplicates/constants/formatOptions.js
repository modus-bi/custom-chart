...
//import '../adaptors/AMcharts3ChartAdaptor/amcharts3/amcharts/amcharts';
  ...
  if (value >= 1) {
    for (c = prefixesOfBigNumbers.length - 1; c > -1; c--) {
      if (value >= prefixesOfBigNumbers[c].number || prefixesOfBigNumbers.length === 1) {
        ...
        //if (prec < 1) prec = 0; // set minimal precision to 1
        ...
        /** Skip not strict numbers **/
        /* отключено 25.01.2019 */
        /* if (strict && newVal != newValTwo) continue; */
        /** Add prefixes **/
...
/** Do Overrides for some AMcharts utils **/
// AmCharts.addZeroes = addZeroes;
// AmCharts.roundTo = roundTo;
// AmCharts.addPrefix = addPrefix;
// AmCharts.formatNumber = formatNumber;
